...
<html>
  <head>
    ...
    <title>Go Raffle Me - Dashboard</title>
            ...
            <div class="col-md-12">
              ...
              <div class="box box-info">
                <div class="box-header with-border">
                  <h3 class="box-title">Fill form below to add event</h3>
                </div><!-- /.box-header -->
                <!-- form start -->
                <form class="form-horizontal" novalidate>
                  ...
                  <!--<div class="box-body">
                    <div class="form-group">
                      <div class="col-sm-offset-2 col-sm-8">
                        <div class="checkbox">
                          <label>
                            <input name="islocal" type="checkbox"> Is Local
                          </label>
                        </div>
                      </div>
                      <div class="col-sm-offset-2 col-sm-8">
                        <div class="checkbox">
                          <label>
                            <input name="isvirtual" type="checkbox"> Is Virtual
                          </label>
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="box-footer">
                    <button type="submit" class="btn btn-info pull-left">Add Event</button>
                  </div><!-- /.box-footer -->
                </form>
              </div><!-- /.box -->
